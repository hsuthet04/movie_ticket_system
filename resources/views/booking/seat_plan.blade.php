                                ...
                                <li class="front-seat">
                                    <ul>
                                        <li class="single-seat">
                                            <img src="{{ asset('assets/images/movie/seat01.png') }}" alt="seat">
                                        </li>
                                        <li class="single-seat">
                                            <img src="{{ asset('assets/images/movie/seat01.png') }}" alt="seat">
                                        </li>
                                ...
                                <li class="front-seat">
                                    <ul>
                                        ...
                                        <li class="single-seat seat-free">
                                            <img src="{{ asset('assets/images/movie/seat01-free.png') }}" alt="seat">
                        ...
                        <li class="seat-line">
                            ...
                            <ul class="seat--area">
                                <li class="front-seat">
                                    <ul>
                                        <li class="single-seat">
                                            <img src="{{ asset('assets/images/movie/seat02.png') }}" alt="seat">
                                        </li>
                                        <li class="single-seat">
                                            <img src="{{ asset('assets/images/movie/seat02.png') }}" alt="seat">
                                        </li>
                                ...
                                <li class="front-seat">
                                    <ul>
                                        ...
                                        <li class="single-seat seat-free-two">
                                            <img src="{{ asset('assets/images/movie/seat02-booked.png') }}"
                                                alt="seat">
